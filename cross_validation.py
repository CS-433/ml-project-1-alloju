...
def cross_validation(
    method, y, x, k_indices, k, lambda_=0.5, initial_w=None, max_iters=100, gamma=0.1
):
...
def best_lambda_and_maxiters_selection(
    method, y, x, x_te, max_iters, k_fold, lambdas, seed=1
):
    ...
    for max_iter in max_iters:
        ...
        for lambda_ in lambdas:
            ...
            temp_mse_te = []
            for k in range(k_fold):
                loss_tr, loss_te, w_tr = cross_validation(
                    method, y, x, x_te, k_indices, k, lambda_, max_iter
                )
                # temp_mse_tr.append(loss_tr)
